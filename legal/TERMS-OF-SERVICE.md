...
"**Service**" means NayaHR's AI-native HR and payroll platform and related websites. "**Customer Data**" means data you or your users submit to the Service, including Employee Personal Data. "**Users**" means individuals you authorise to use the Service (e.g. owners, HR admins, managers, employees).

## 2. The Service & licence

Subject to these Terms and payment of fees, NayaHR grants you a non-exclusive, non-transferable, non-sublicensable right to access and use the Service for your internal business purposes during the subscription term.

## 3. Accounts & eligibility

Access is **invitation-based**. You are responsible for authorising Users, assigning roles, keeping credentials secure, and for all activity under your account. You must provide accurate account information and be capable of forming a binding contract.

## 4. Customer responsibilities

You are responsible for: (a) the accuracy, quality and legality of Customer Data; (b) establishing a **lawful basis** for processing Employee Personal Data, including any required notices to and consents from your employees; (c) your Users' compliance with these Terms; and (d) using the Service in compliance with applicable law. You will not misuse the Service, attempt to breach its security or tenant isolation, reverse engineer it, or use it to store unlawful content.
...
NayaHR and its licensors own all rights in the Service, including its software, design and content (excluding Customer Data). You retain all rights in Customer Data and grant NayaHR a limited licence to host and process it solely to provide, secure and support the Service. Feedback you give may be used by NayaHR without restriction.

## 9. Confidentiality

Each party will protect the other's non-public information disclosed under these Terms and use it only to perform under these Terms, except where disclosure is required by law.
...
We will provide the Service with reasonable skill and care. Except as expressly stated, the Service is provided **"as is"** and we disclaim all other warranties to the extent permitted by law. The Service supports statutory computations (e.g. PF, ESI, PT, TDS) but **you remain responsible for verifying statutory filings and payments**; TDS and similar figures are estimates unless you configure them otherwise, and NayaHR is not your tax, legal or accounting advisor.
...
These Terms (with the Privacy Policy and DPA) are the entire agreement between the parties on this subject. If any provision is unenforceable, the rest remains in effect. Neither party is liable for delays caused by events beyond reasonable control (force majeure). You may not assign these Terms without our consent; we may assign to an affiliate or successor. No waiver is implied by a failure to enforce.
